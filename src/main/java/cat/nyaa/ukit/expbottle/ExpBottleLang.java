...
public class ExpBottleLang {
    public Text help = Text.of(
            "&7Usage:",
            "&7    /ukit expbottle add <amount>: add experience to experience bottles in your hand",
            "&7    /ukit expbottle extract <amount>: take out experience from the experience bottles in your hand."
    );
