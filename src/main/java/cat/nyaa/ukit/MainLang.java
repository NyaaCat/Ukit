...
import cat.nyaa.ukit.expbottle.ExpBottleLang;
...
public class MainLang {
    public CommonLang commonLang = new CommonLang();
    public ShowLang showLang = new ShowLang();
    ...
    public ExpBottleLang expBottleLang = new ExpBottleLang();
}
